window.onload = () => {
    ...
    let t2 = document.getElementById("lcc");
     ...
     let foo8= document.getElementById("fo8");
     let foo9 = document.getElementById("fo9");
     ...
     function mudar() {
        if (mod) {
           ...
           foo3.style.color = "#cdcdcdff"
            ...
            foo8.style.color = "#cdcdcdff"
            foo9.style.color = "#cdcdcdff"
...
foo4.addEventListener("mouseleave", () => {
    foo4.style.color = "#cdcdcdff";
            ...
            foo7.style.color = "#281d28ff"
             foo8.style.color = "#281d28ff"
            foo9.style.color = "#281d28ff"
  foo.addEventListener("mouseenter", () => {
